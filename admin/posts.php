 ...
 -->
   ...
   echo " <br><br><br><br><br><h2 align='center'>List of All Registered Users</h2><br>
    ...
    foreach ($users as $user) {
        ...
        $option = "
        <button class='btn btn-primary btn-xs btn-link' title=' Update this record' onclick='updateRecord({$user->tweetID});return false;'>Suspend</button>
        <button class='btn btn-warning btn-xs btn-link' title='Delete this record' onclick='deleteRecord({$user->tweetID});return false;'>Delete</button>";
echo 
        "<table class='table table-condensed table-striped table-bordered table-sm'>
        <tbody>
